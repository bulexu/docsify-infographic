...
var plugin = function plugin(config) {
  return function (hook) {
    hook.afterEach(function (html, next) {
      ...
      htmlElement.querySelectorAll('pre[data-lang=infographic]').forEach(function (element) {
    ...
    hook.doneEach(function () {
      var _ref = window.AntVInfographic || {},
        Infographic = _ref.Infographic;
      if (!Infographic) {
        console.warn('@antv/infographic is not loaded.');
        return;
      }
      var containers = document.querySelectorAll('.infographic');
      var _ref2 = config || {},
